  ...
  return (
      <div className="min-h-screen text-foreground">
        <div className="mx-auto max-w-2xl px-4 py-6 sm:py-10">
          ...
          {screen === "dashboard" && (
            <Dashboard onSolo={startSolo} onBot={startBot} onOnline={startOnline} onParty={startParty} />
          )}
...
function Dashboard({ onSolo, onBot, onOnline, onParty }: { onSolo: () => void; onBot: () => void; onOnline: () => void; onParty: () => void }) {
  const { t } = useLang();
  return (
